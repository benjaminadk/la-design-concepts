...
const { directoryExists, readFile, mkdir, rm, createWriteStream } = require('./lib/utils')

program
    .option('-t, --txt [filename]', 'Text file listing desired image urls', 'images.txt')
    .option('-d, --destination [folder]', 'Directory to save image copies in', 'images')
    .parse(process.argv)
